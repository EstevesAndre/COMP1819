...
public class JasminGenerator implements ASTNodeVisitor {
    ...
    public String getIntegerInstruction(String value) {
        String out = "";
    ...
    public String getVarInstruction(String instruction, int value) {
    ...
    public String visit(ASTlt node) {
        ...
        if (local == null) {
            ...
            out += "LABEL" + label2 + ":\n" + getVarInstruction("istore", local.order) + "\n";
    ...
    public String visit(ASTmult node) {
        ...
        if (local == null) {
            ...
            out += getVarInstruction("istore", local.order) + "\n";
        }
    ...
    public String visit(ASTid node) {
        ...
        if (assign != null) {
            if (local == null) {
                ...
                outinst += getVarInstruction("istore", local.order) + "\n";
            }
        }
    ...
    public String visit(ASTStatement node) {
        ...
        if (node.assign) {
            ...
            if (!node.array) {
                ...
                if (local == null) {
                    ...
                    out += getVarInstruction("aload", local.order) + "\n";
        ...
        if (node.assign && node.children != null && node.children[0] instanceof AST_this) {
            ...
            if (local == null) {
                ...
                out += getVarInstruction("astore", local.order) + "\n";
            }
    ...
    public String visit(ASTMethodDeclaration node) {
        ...
        if (return_value instanceof ASTliteral) {
            out += getIntegerInstruction(((ASTliteral) return_value).info) + "\n";
            ...
            if (entry != null) {
                if (entry.type.equals("int") || entry.type.equals("bool"))
                    out += getVarInstruction("iload", entry.order) + "\n";
                else
                    out += getVarInstruction("aload", entry.order) + "\n";
            } else {
    ...
    public String getJasminRecursive(Node node) {
        ...
        if (node instanceof ASTliteral) {
            out = getIntegerInstruction(((ASTliteral) node).info) + "\n";
            ...
            out = "iconst_" + (((ASTbool) node).info ? 1 : 0) + "\n";
        else if (node instanceof ASTlt)
            out = getJasminRecursive((ASTlt) node);
        else if (node instanceof ASTnot)
            out = getJasminRecursive((ASTnot) node);
    ...
    public String visit(ASTliteral node) {
        ...
        if (assign != null) {
            if (local == null) {
                if (global != null) {
                    out += "aload_0\n";
                    out += getIntegerInstruction(node.info) + "\n";
                    out += "putfield " + node.getClassName() + "/" + global.id + " "
                            + SimpleNode.getJasminType(global.type) + "\n";
                }
            } else {
    ...
    String getJasminRecursive(ASTmult node) {
        ...
        if (node.children[1] instanceof ASTid) {
            ...
            if (local_1 == null) {
                ...
                out += getVarInstruction("iload", local_1.order) + "\n";
            }
        } else
